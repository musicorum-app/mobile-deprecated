...
List<double> RANDOM_SIZES = [TagsFragment.getRandom(), TagsFragment.getRandom(), TagsFragment.getRandom(), TagsFragment.getRandom(), TagsFragment.getRandom(), TagsFragment.getRandom()];
...
class TagsFragment extends StatelessWidget {
  ...
  Color get color {
    return _color != null ? _color.toTinyColor().brighten(30).color : Colors.white;
  }
